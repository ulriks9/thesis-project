...
class UNet(nn.Module):
    def __init__(
        ...
        self.encoder_pool1 = nn.MaxPool2d(kernel_size=self.kernel_size, stride=self.stride)
        ...
        self.encoder_pool2 = nn.MaxPool2d(kernel_size=self.kernel_size, stride=self.stride)
        ...
        self.encoder_pool3 = nn.MaxPool2d(kernel_size=self.kernel_size, stride=self.stride)
        ...
        # Decoder blocks:
        self.decoder_up_1 = nn.ConvTranspose2d(in_channels=self.features[2] * 2, out_channels=self.features[2], kernel_size=self.kernel_size, stride=self.stride)
        ...
        self.decoder_up_2 = nn.ConvTranspose2d(in_channels=self.features[2], out_channels=self.features[1], kernel_size=self.kernel_size, stride=self.stride)
        ...
        self.decoder_up_3 = nn.ConvTranspose2d(in_channels=self.features[1], out_channels=self.features[0], kernel_size=self.kernel_size, stride=self.stride)
        ...
        self.final_conv = nn.Conv2d(in_channels=self.features[0], out_channels=self.out_channels, kernel_size=self.kernel_size, padding=self.padding)
